      ...
      {current && (
        <div className="card">
          ...
          <div className="tabs" style={{ padding: '0 20px' }}>
            {[['', 'All'], ['QUEUED', 'Queued'], ['PROCESSING', 'Processing'], ['RETRYING', 'Retrying'], ['VERIFIED', 'Verified'], ['COVERAGE_GAP_FLAGGED', 'Coverage gap'], ['NEEDS_MANUAL_REVIEW', 'Needs review']].map(([v, l]) => (
